...
require('lazy').setup({
...

  {
    ...
    config = function()
      require 'custom/plugins/extensions/gitsigns'
    end,
  },
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>gr', group = '[G]oto LSP [R]eference' },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        require 'custom/plugins/extensions/telescope',
      }
  ...
  { -- Autocompletion
    ...
    dependencies = {
      -- Snippet Engine
      {
        ...
        opts = {},
        config = function()
          require 'custom/plugins/extensions/luasnip'
        end,
      },
      'folke/lazydev.nvim',
    },
